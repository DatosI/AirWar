...
public class BalaGrafica extends Bala implements Dibujable{
	...
	public BalaGrafica(Coordenadas ba, float radio, Color Uncolor, Image imagenbala){		//Recibe la coordenadas de bala con su radio
		super(ba,radio);
		this.color=Uncolor;
	...
	public void dibujar(Graphics darreglo){
		...
		BalaGrafica bala=new BalaGrafica(salida,10,Color.GREEN,imagenbala);
	}
